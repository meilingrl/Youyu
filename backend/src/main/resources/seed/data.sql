...
VALUES (9001, 'admin',
    ...
    'Platform Admin', 'active', 'ADMIN', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
...
(1010, 'seedbuyer', '13800000010', 'seedbuyer@campus.edu.cn', '$2a$10$hPahEgkO9/nkJVoY5etkIO7tO50pBlujmFhcAWJ6Pw.kDpzDu7nJG', 'Chen Bo', '', 'active', '2026-05-10 08:00:00', NULL, '2026-05-10 08:00:00', CURRENT_TIMESTAMP),
(1011, 'seedbuyer2', '13800000011', 'seedbuyer2@campus.edu.cn', '$2a$10$VbnVgh/nPlDNnYeuos5HkePah.XJAmzxZaEk6JTYrqgxduBO7Aep.', 'Liu Yue', '', 'active', '2026-05-10 08:05:00', NULL, '2026-05-10 08:05:00', CURRENT_TIMESTAMP),
(1012, 'seedbuyer3', '13800000012', 'seedbuyer3@campus.edu.cn', '$2a$10$hAEXKhS/5z9bHhc.q62tV.bPdScZg84hUJcfmvLkoWi/58/Eqjys2', 'Gao Lin', '', 'active', '2026-05-10 08:10:00', NULL, '2026-05-10 08:10:00', CURRENT_TIMESTAMP),
(1013, 'seedbuyer4', '13800000013', 'seedbuyer4@campus.edu.cn', '$2a$10$Qvr6K2FMf5wIneefReslV.4.y05Q7yvQECBqSoD9ExdmOTZWGUpcO', 'Xu Ke', '', 'active', '2026-05-10 08:12:00', NULL, '2026-05-10 08:12:00', CURRENT_TIMESTAMP);
...
INSERT INTO users (id, username, phone, email, password_hash, nickname, avatar, status, registered_at, last_login_at, created_at, updated_at)
VALUES
(1099, 'platform_cs', '13800001099', 'cs@campus.edu.cn', '$2a$10$jJy4r2olYY7ca7bAvZRuJe9Z77E.JZxzVTugqYw6S8lr4ahKU2hqG', 'Campus Support', '', 'active', '2026-04-01 09:00:00', NULL, '2026-04-01 09:00:00', CURRENT_TIMESTAMP)
...
(2004, 1010, '20240110', 'Chen Bo', 'Computer Science', 'Software Engineering', '2024', 'seedbuyer@campus.edu.cn', 'manual_review', 'approved', '2026-05-10 09:00:00', '2026-05-10 09:30:00', 9001, '', 'approved for campus trading', FALSE, '2026-05-10 09:00:00', CURRENT_TIMESTAMP),
(2005, 1011, '20240111', 'Liu Yue', 'Economics', 'Finance', '2024', 'seedbuyer2@campus.edu.cn', 'manual_review', 'pending_review', '2026-05-10 09:10:00', NULL, NULL, '', '', FALSE, '2026-05-10 09:10:00', CURRENT_TIMESTAMP),
(2006, 1012, '20240112', 'Gao Lin', 'Mechanical Engineering', 'Mechatronics', '2024', 'seedbuyer3@campus.edu.cn', 'manual_review', 'approved', '2026-05-10 09:15:00', '2026-05-10 09:45:00', 9001, '', 'approved for campus trading', FALSE, '2026-05-10 09:15:00', CURRENT_TIMESTAMP),
(2007, 1013, '20240113', 'Xu Ke', 'Automation', 'Robotics', '2025', 'seedbuyer4@campus.edu.cn', 'manual_review', 'approved', '2026-05-10 09:18:00', '2026-05-10 09:50:00', 9001, '', 'approved for campus trading', FALSE, '2026-05-10 09:18:00', CURRENT_TIMESTAMP);
...
(7002, 1010, 'Chen Bo', '13800000010', 'campus', 'Liaoning', 'Shenyang', 'Hunnan', 'NEU Hunnan Campus Dorm 7', 'Hunnan Campus', TRUE, '2026-05-10 09:00:00', CURRENT_TIMESTAMP),
(7003, 1011, 'Liu Yue', '13800000011', 'campus', 'Liaoning', 'Shenyang', 'Hunnan', 'NEU Hunnan Library Annex', 'Hunnan Campus', TRUE, '2026-05-10 09:05:00', CURRENT_TIMESTAMP),
(7004, 1012, 'Gao Lin', '13800000012', 'campus', 'Liaoning', 'Shenyang', 'Hunnan', 'NEU Gym Locker 12', 'Hunnan Campus', TRUE, '2026-05-10 09:20:00', CURRENT_TIMESTAMP),
(7005, 1013, 'Xu Ke', '13800000013', 'campus', 'Liaoning', 'Shenyang', 'Hunnan', 'NEU Innovation Building B1', 'Hunnan Campus', TRUE, '2026-05-10 09:22:00', CURRENT_TIMESTAMP);
...
(4010, 1010, 'Campus Exchange Corner', 'Frequently updated second-hand study tools and dorm electronics.', NULL, 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=900&q=80', 'Campus pickup preferred.', 'active', 'approved', CURRENT_TIMESTAMP, 9001, NULL, 4.95, 3, FALSE, '2026-05-10 08:00:00', CURRENT_TIMESTAMP),
(4011, 1012, 'Robotics Supply Mart', 'Second-hand lab tools and cables from student club turnover.', NULL, 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=900&q=80', 'Meet at maker space after 6pm.', 'active', 'approved', CURRENT_TIMESTAMP, 9001, NULL, 4.70, 1, FALSE, '2026-05-10 08:12:00', CURRENT_TIMESTAMP);
...
(3010, 1010, 4010, 3, 'Compact USB Hub 4-Port', 'Barely used, boxed', 'USB 3.0 hub for dorm desk setup.', 'USB 3.0 hub for dorm desk setup.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1625948515291-69613efd103f?auto=format&fit=crop&w=900&q=80', 22.00, 45.00, 5, TRUE, TRUE, FALSE, FALSE, NULL, 5, 0, FALSE, '2026-05-10 08:30:00', CURRENT_TIMESTAMP),
(3011, 1010, 4010, 4, 'Wireless Mouse Campus Edition', 'Logistics or campus meet', 'Lightweight mouse for laptop.', 'Lightweight mouse for laptop.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1527814050087-3793815479db?auto=format&fit=crop&w=900&q=80', 16.50, 32.00, 8, TRUE, TRUE, FALSE, FALSE, NULL, 3, 0, FALSE, '2026-05-10 08:35:00', CURRENT_TIMESTAMP),
(3012, 1010, 4010, 2, 'Scientific Calculator Exam Model', 'TI-style for exams', 'Approved models only; battery included.', 'Approved models only; battery included.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1587145820266-a5951ee786f4?auto=format&fit=crop&w=900&q=80', 48.00, 89.00, 4, TRUE, TRUE, FALSE, FALSE, NULL, 11, 2, FALSE, '2026-05-10 08:40:00', CURRENT_TIMESTAMP),
(3013, 1012, 4011, 4, 'Braided USB-C Cable 2m', 'Braided', 'High-speed charging cable.', 'High-speed charging cable.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1621478374422-35206faaed30?auto=format&fit=crop&w=900&q=80', 9.90, 25.00, 20, TRUE, TRUE, FALSE, FALSE, NULL, 7, 1, FALSE, '2026-05-10 08:45:00', CURRENT_TIMESTAMP),
(3014, 1012, 4011, 2, 'Compact Multimeter Mini', 'For lab course', 'Compact multimeter for intro circuits.', 'Compact multimeter for intro circuits.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=900&q=80', 42.00, 79.00, 2, FALSE, TRUE, FALSE, FALSE, NULL, 4, 0, FALSE, '2026-05-10 08:48:00', CURRENT_TIMESTAMP),
(3021, 1010, 4010, 4, 'Quiet-Key Mechanical Keyboard', 'Hot-swap compact layout', 'Compact mechanical keyboard suitable for study desks and late-night use.', 'Compact mechanical keyboard suitable for study desks and late-night use.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1587829741301-dc798b83add3?auto=format&fit=crop&w=900&q=80', 128.00, 199.00, 3, TRUE, TRUE, FALSE, FALSE, NULL, 19, 4, FALSE, '2026-06-04 09:00:00', CURRENT_TIMESTAMP),
(3022, 1012, 4011, 4, 'Bluetooth Headset Study Version', 'Low-latency over-ear set', 'Bluetooth headset for library, dorm, and online-class use.', 'Bluetooth headset for library, dorm, and online-class use.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?auto=format&fit=crop&w=900&q=80', 88.00, 159.00, 6, TRUE, TRUE, FALSE, FALSE, NULL, 23, 6, FALSE, '2026-06-04 09:05:00', CURRENT_TIMESTAMP),
(3023, 1010, 4010, 2, 'Calculator Study Bundle', 'Exam-ready essentials', 'Calculator bundle paired with a durable sleeve and quick-reference card.', 'Calculator bundle paired with a durable sleeve and quick-reference card.', 'physical', 'on_sale', 'not_required', NULL, 'https://images.unsplash.com/photo-1587145820266-a5951ee786f4?auto=format&fit=crop&w=900&q=80', 58.00, 99.00, 5, TRUE, TRUE, FALSE, FALSE, NULL, 17, 3, FALSE, '2026-06-04 09:10:00', CURRENT_TIMESTAMP)
...
(6201, 'SUP-2026-0001', 1001, 'order', 'Order pickup support', 'I need help confirming an offline pickup detail.', 'waiting_user', 'normal',
 'order', 8001, 9102, 'admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(6202, 'SUP-2026-0002', 1010, 'account', 'Account verification question', 'Please check my campus verification status.', 'open', 'normal',
