...
| 任务 ID | 功能 | 业务价值 | 预计工时 |
|---------|------|----------|----------|
| task-03 | 商品卡片消息 | 快速分享商品链接,提升转化率 | 6-8h |
| task-04 | 订单卡片消息 | 关联订单,方便售后沟通 | 6-8h |
| task-06 | 快捷回复 | 卖家常用语库,提升响应速度 | 6-8h |
...
P1 阶段（3个任务,部分并行）:
├─ task-03: 商品卡片消息 [依赖 task-02]
├─ task-04: 订单卡片消息 [依赖 task-02]
└─ task-06: 快捷回复 [独立]
