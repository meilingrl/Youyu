...
- [x] `feature-polish-messages-chat-window-layout`
- [x] `feature-polish-explore-filter-search-sort`
- [x] `feature-polish-cart-selection-review-images`
- [x] `feature-polish-refund-logistics-map-reconciliation`
- [x] `feature-polish-admin-permission-assignment`
- [x] `feature-polish-admin-dashboard-metrics`
- [x] `feature-polish-admin-data-export`
- [x] `feature-polish-integration-verification`
...
- Executed the closeout from an isolated worktree on `codex/feature-polish-closeout`, preserving the originating dirty tree on `chore/docs-cleanup-and-stage-patch`.
- Landed Wave 1 plus refund/logistics as focused commits, then finished the admin role/dashboard/export slice with final live verification, docs updates, and archival preparation.
