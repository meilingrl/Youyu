...
- Implemented `GET /api/chat/messages/search` with keyword/time filters, pagination, participant scoping, and soft-delete filtering.
- Added `MessageSearch.vue` and Pinia search state for the message-center search panel.
